/*======================================================================
**
**  File: chimu/form/FormRuntimeException.java
**
...
import com.chimu.kernel.exceptions.RuntimeWrappedException;

/**
FormRuntimeException is a generic exception coming from the FORM
...
@see com.chimu.form.ExecutionException
@see com.chimu.form.ConfigurationException
@see com.chimu.form.transaction.TransactionException
**/
public class FormRuntimeException extends RuntimeWrappedException implements FormThrowInfo {
    public FormRuntimeException(String detail) {
	    super(detail);
    }

    public FormRuntimeException(String detail, Throwable wrappedThrowable) {
