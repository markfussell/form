/*======================================================================
**
**  File: chimu/form/database/typeConstants/SqlDataTypeCharC.java
**
...
public class SqlDataTypeCharC extends SqlDataTypeAbsC {
    ...
    public String stringRep(DatabaseProduct dbProduct, int length) {
        String aString = dbProduct.typeChar();
        if (aString != null) {
            if (length >0) {
