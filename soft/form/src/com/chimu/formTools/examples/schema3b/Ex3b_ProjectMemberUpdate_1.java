/*======================================================================
**
**  File: com/chimu/formTools/examples/schema3b/Ex3b_ProjectMemberUpdate_1.java
**
...
public class Ex3b_ProjectMemberUpdate_1 extends ExampleAbsC {
    ...
    public void run (Connection jdbcConnection) {
        ...
        for (int i = 0; i < size; i++) {
            outputStream.println("Project Member " + (i+1) + " is an " + ((Employee) aSeq.atIndex(i)).info());
        };
