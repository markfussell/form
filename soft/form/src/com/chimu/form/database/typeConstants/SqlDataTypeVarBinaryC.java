/*======================================================================
**
**  File: chimu/form/database/typeConstants/SqlDataTypeVarBinaryC.java
**
...
public class SqlDataTypeVarBinaryC extends SqlDataTypeAbsC {
    ...
    public String stringRep(DatabaseProduct dbProduct, int length) {
        String aString = dbProduct.typeVarBinary();
        if (aString != null) {
            if (length >0) {
    ...
    //(P)******************* Constructors **********************
    //**********************************************************
    protected SqlDataTypeVarBinaryC() {}
