/*======================================================================
**
**  File: com/chimu/formTools/examples/schema4/CompanyC.java
**
...
public class CompanyC extends DomainObjectAbsC implements Company {
    ...
    public String info() { unstub();
        String retString = " with revenue unknown.";
        if (this.revenue == null) retString = " with revenue: $ " + this.revenue;
        return this.name + retString;
    }
