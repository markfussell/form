/*======================================================================
**
**  File: com/chimu/formTools/examples/schema3/Ex3_Query_1.java
**
...
public class Ex3_Query_1 extends ExampleAbsC {
    ...
    //==========================================================
        ...
        for (Enumeration enum = employees.elements(); enum.hasMoreElements();) {
            ...
            for (Enumeration fnum = projects.elements(); fnum.hasMoreElements();) {
                Project aProject = (Project) fnum.nextElement();
                outputStream.println("Projects " + aProject.info());
            };
