/*======================================================================
**
**  File: com/chimu/formTools/examples/schema4c/Ex4c_CompanyInsert_1.java
**
...
public class Ex4c_CompanyInsert_1 extends ExampleAbsC {
    ...
    //==========================================================
        ...
        Money revenue = new MoneyC("DEM", new BigDecimal("1000.00"));
