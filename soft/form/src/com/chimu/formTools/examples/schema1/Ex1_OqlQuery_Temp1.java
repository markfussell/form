/*======================================================================
**
**  File: com/chimu/formTools/examples/schema1/Ex1_OqlQuery_Temp1.java
**
...
public class Ex1_OqlQuery_Temp1 extends ExampleAbsC {
    ...
    public void run (Connection jdbcConnection) {
        ...
        OqlQuery oql = orm.newOqlQuery(
                "FROM Person person "+
                "WHERE       person.height * 1.5 >= :minHeight "+
                "        AND person.height - 2   <= :maxHeight + 2"+
