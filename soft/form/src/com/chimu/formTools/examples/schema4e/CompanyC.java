/*======================================================================
**
**  File: com/chimu/formTools/examples/schema4e/CompanyC.java
**
...
public class CompanyC extends DomainObjectAbsC implements Company {
    ...
    public String info() { unstub();
        String revenueStr = "revenue unknown";
        String cityName = "city unknown ";
        if (this.name == null) {
            return "Company has no name";
        };
        if (this.revenue != null) {
            revenueStr = "with revenue: " + this.revenue.toString();
        };
        if (this.city != null) {
            cityName = "City: " + this.city.name();
        };
        return "Company name: " + this.name + " " + cityName + " " + revenueStr;
    }
...
//<GenerateObjectBinding{
    //FORM Preprocessor Version 1.7 ran on: Fri Oct 31 17:45:27 PST 1997
