/*======================================================================
**
**  File: chimu/kernel/collections/impl/ms/WeakHashtableC.java
**
 ...
 */
class WeakHashtableEntryC extends WeakReference {
    int hash;
    Object key;
    WeakHashtableEntryC next;

    WeakHashtableEntryC(Object value) {
        super(value);
    }

    protected Object clone() {
        WeakHashtableEntryC entry = new WeakHashtableEntryC(value());
        entry.hash = hash;
        entry.key = key;
...
class WeakHashtableC extends Dictionary implements Cloneable, java.io.Serializable {
    ...
    public synchronized Object put(Object key, Object value) {
        ...
        WeakHashtableEntryC e = new WeakHashtableEntryC(value);
        e.hash = hash;
        e.key = key;
        e.next = tab[index];
        tab[index] = e;
