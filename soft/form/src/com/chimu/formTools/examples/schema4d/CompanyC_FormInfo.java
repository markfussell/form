/*======================================================================
**
**  File: com/chimu/formTools/examples/schema4d/CompanyC_FormInfo.java
**
...
public class CompanyC_FormInfo extends DomainObjectAbsC_FormInfo {
    ...
    public void configureMappers() {
        ...
        myMapper.newTransformSlot_column_type_decoder_encoder("revenue", "revenuePair", BigDecimal.class, MoneyC.decodeFunctor(), MoneyC.encodeFunctor());
