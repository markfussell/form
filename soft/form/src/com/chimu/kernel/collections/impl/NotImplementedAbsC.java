/*======================================================================
**
**  File: chimu/kernel/collections/impl/NotImplementedAbsC.java
**
...
public abstract class NotImplementedAbsC
            implements List {
    ...
    public boolean addAll(Collection elements) throws IllegalElementException {if (DEBUG) notImplementedYet(); return false;};
