/*======================================================================
**
**  File: com/chimu/formTools/examples/schema2/Ex2_CompanyRetrieval_1.java
**
...
public class Ex2_CompanyRetrieval_1 extends ExampleAbsC {
    ...
    public void run (Connection jdbcConnection) {
        ...
        for (int i = 0; i<size; i++) {
            ...
            outputStream.println(company.info() + " employs " + employees.size()+" employees");
        };
    }
}