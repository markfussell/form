/*======================================================================
**
**  File: com/chimu/formTools/examples/schema4b/ProjectC_FormInfo.java
**
...
public class ProjectC_FormInfo extends DomainObjectAbsC_FormInfo {
    ...
    public void configureMappers() {
       super.configureMappers();
        ...
        myMapper.newDirectSlot_column_type("profitMargin", "profit_margin", Double.class);
/*
        myMapper.newTransformSlot_column_type_decoder_encoder("profitMargin", "profit_margin",
            Double.class, TranslationLib.numberToDoubleFunction(), TranslationLib.numberToBigDecimalFunction());
*/
    }
