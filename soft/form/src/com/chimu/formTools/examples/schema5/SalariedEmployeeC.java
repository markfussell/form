/*======================================================================
**
**  File: com/chimu/formTools/examples/schema5/SalariedEmployeeC.java
**
...
public class SalariedEmployeeC extends EmployeeAbsC implements SalariedEmployee {
    ...
    public String toString() {unstub();
       return "<Salaried Employee #"+myOid+" name "+name+ " height " + height + " email " + email +" hiredDate " + hiredDate+" salary " + salary + ">";
    }
        /**
        ==  Returns a string that is for display.
        **/
    public String info() {unstub();
        String salString = " unknown.";
        if (annualSalary() != null) salString = annualSalary().toString();

        return "Salaried Employee name: " + name() + " salary " + salString;
    }
