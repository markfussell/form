/*======================================================================
**
**  File: com/chimu/formTools/examples/schema3b/Ex3b_ProjectMemberUpdate_3.java
**
...
/**
    Replaces the entire collection.  Going from a bigger collection of project members
    to a smaller collection
**/

public class Ex3b_ProjectMemberUpdate_3 extends ExampleAbsC {
    ...
    public void run (Connection jdbcConnection) {
        ...
        outputStream.println("Prior to updating project members ");
        ...
        outputStream.println( "After updating project members ");
